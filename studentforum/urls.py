...
urlpatterns = [
    ...
    url(r'^infoChange/actions/([0-9]+)$', views.showActions, name='foractions'),
    url(r'^infoChange/collects/([0-9]+)$', views.showCollects, name='forcollects'),
    ...
    url(r'^center/', views.center, name='forcenter'),
]
